...
const nyoutube = ('🏴‍☠️ ZeroTwoBOT\nYoutube/Sc :\nhttps://youtube.com/c/GilangYT')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
        ...
        var prefix = prefa ? /^[°•π÷×¶∆£¢€¥®™+✓_=|~!?@#$%^&.🏴‍☠️^]/gi.test(body) ? body.match(/^[°•π÷×¶∆£¢€¥®™+✓_=|~!?@#$%^&.🏴‍☠️^]/gi)[0] : "" : prefa ?? global.prefix
...
jumlahharian = `${dataa.value}`
	...
	// auto set bio
		...
		await naze.setStatus(`ZeroTwoBot By Gilang | Runtime : ${runtime(uptime)}`)
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'rate': {
                ...
                let jawab = `*Apakah ${text}*\nJawab : ${te}`
            naze.sendMessage(m.chat, { text: `Rate : *${te}%*` }, { quoted: m })
					}
            break
            case 'katasenja': {
           ...
           case 'yasin': {
			...
			case 'tanyakerang': case 'kerangajaib': case 'kerang': {
				...
				break
				case 'fitnah': {
if (args.length < 1) return reply(`Usage :\n.fake [nomor|pesan|balasanbot]]\n\nEx : \n.fake 0|hai|hai juga markenlin`)
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            break
            case 'igowner': {
                m.reply('https://instagram.com/bilgilngg/')
            }
            break
            case 'pacarowner': {
                m.reply('Kamu ///<////')
...
🏴‍☠️ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                naze.sendImage(m.chat, media.thumb, `🏴‍☠️ Title : ${media.title}\n🏴‍☠️ File Size : ${media.filesizeF}\n🏴‍☠️ Url : ${isUrl(text)}\n🏴‍☠️ Ext : MP3\n🏴‍☠️ Resolusi : ${args[1] || '128kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                naze.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `🏴‍☠️ Title : ${media.title}\n🏴‍☠️ File Size : ${media.filesizeF}\n🏴‍☠️ Url : ${isUrl(text)}\n🏴‍☠️ Ext : MP3\n🏴‍☠️ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
		...
		let { pinterest } = require('./lib/scraper')
                ...
                naze.sendMessage(m.chat, { image: { url: result }, caption: '🏴‍☠️ Media Url : '+result }, { quoted: m })
            }
            break
            case 'waifu': {
...
break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Mimpi :* ${anu.message.mimpi}\n🏴‍☠️ *Arti :* ${anu.message.arti}\n🏴‍☠️ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama Anda :* ${anu.message.nama_anda.nama}\n🏴‍☠️ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n🏴‍☠️ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n🏴‍☠️ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n🏴‍☠️ *Hasil :* ${anu.message.result}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama Suami :* ${anu.message.suami.nama}\n🏴‍☠️ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n🏴‍☠️ *Nama Istri :* ${anu.message.istri.nama}\n🏴‍☠️ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n🏴‍☠️ *Hasil :* ${anu.message.result}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama Anda :* ${anu.message.nama_anda.nama}\n🏴‍☠️ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n🏴‍☠️ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n🏴‍☠️ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n🏴‍☠️ *Sisi Positif :* ${anu.message.sisi_positif}\n🏴‍☠️ *Sisi Negatif :* ${anu.message.sisi_negatif}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama :* ${anu.message.nama}\n🏴‍☠️ *Arti :* ${anu.message.arti}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendImage(m.chat,  anu.message.gambar, `🏴‍☠️ *Nama Anda :* ${anu.message.nama_anda}\n🏴‍☠️ *Nama Pasangan :* ${anu.message.nama_pasangan}\n🏴‍☠️ *Sisi Positif :* ${anu.message.sisi_positif}\n🏴‍☠️ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Tanggal Pernikahan :* ${anu.message.tanggal}\n🏴‍☠️ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Lahir :* ${anu.message.hari_lahir}\n🏴‍☠️ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'pekerjaan': case 'kerja': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Lahir :* ${anu.message.hari_lahir}\n🏴‍☠️ *Pekerjaan :* ${anu.message.pekerjaan}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Analisa :* ${anu.message.analisa}\n🏴‍☠️ *Angka Akar :* ${anu.message.angka_akar}\n🏴‍☠️ *Sifat :* ${anu.message.sifat}\n🏴‍☠️ *Elemen :* ${anu.message.elemen}\n🏴‍☠️ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendImage(m.chat, anu.message.image, `🏴‍☠️ *Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Simbol Tarot :* ${anu.message.simbol_tarot}\n🏴‍☠️ *Arti :* ${anu.message.arti}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama :* ${anu.message.nama}\n🏴‍☠️ *Lahir :* ${anu.message.tahun_lahir}\n🏴‍☠️ *Gender :* ${anu.message.jenis_kelamin}\n🏴‍☠️ *Angka Kua :* ${anu.message.angka_kua}\n🏴‍☠️ *Kelompok :* ${anu.message.kelompok}\n🏴‍☠️ *Karakter :* ${anu.message.karakter}\n🏴‍☠️ *Sektor Baik :* ${anu.message.sektor_baik}\n🏴‍☠️ *Sektor Buruk :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
                if (!text) throw `Example : ${prefix + command} 7,7,2005`
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Kala Tinantang :* ${anu.message.kala_tinantang}\n🏴‍☠️ *Info :* ${anu.message.info}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Hari Lahir :* ${anu.message.hari_lahir}\n🏴‍☠️ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Hari Naas :* ${anu.message.hari_naas}\n🏴‍☠️ *Info :* ${anu.message.catatan}\n🏴‍☠️ *Catatan :* ${anu.message.info}`, m)
            }
            break
            case 'nagahari': case 'harinaga': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Hari Lahir :* ${anu.message.hari_lahir}\n🏴‍☠️ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Arah Naga Hari :* ${anu.message.arah_naga_hari}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'arahrejeki': case 'arahrezeki': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Hari Lahir :* ${anu.message.hari_lahir}\n🏴‍☠️ *tanggal Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Arah Rezeki :* ${anu.message.arah_rejeki}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'peruntungan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama :* ${anu.message.nama}\n🏴‍☠️ *Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Peruntungan Tahun :* ${anu.message.peruntungan_tahun}\n🏴‍☠️ *Hasil :* ${anu.message.result}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Tanggal :* ${anu.message.tanggal}\n🏴‍☠️ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n🏴‍☠️ *Watak Hari :* ${anu.message.watak_hari}\n🏴‍☠️ *Naga Hari :* ${anu.message.naga_hari}\n🏴‍☠️ *Jam Baik :* ${anu.message.jam_baik}\n🏴‍☠️ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            case 'sifat': case 'karakter': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Nama :* ${anu.message.nama}\n🏴‍☠️ *Lahir :* ${anu.message.tgl_lahir}\n🏴‍☠️ *Garis Hidup :* ${anu.message.garis_hidup}`, m)
            }
            break
            case 'keberuntungan': {
                if (!text) throw `Example : ${prefix + command} Dika, 7,7,2005`
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Hasil :* ${anu.message.result}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            ...
            case 'zodiak': case 'zodiac': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `🏴‍☠️ *Zodiak :* ${anu.message.zodiak}\n🏴‍☠️ *Nomor :* ${anu.message.nomor_keberuntungan}\n🏴‍☠️ *Aroma :* ${anu.message.aroma_keberuntungan}\n🏴‍☠️ *Planet :* ${anu.message.planet_yang_mengitari}\n🏴‍☠️ *Bunga :* ${anu.message.bunga_keberuntungan}\n🏴‍☠️ *Warna :* ${anu.message.warna_keberuntungan}\n🏴‍☠️ *Batu :* ${anu.message.batu_keberuntungan}\n🏴‍☠️ *Elemen :* ${anu.message.elemen_keberuntungan}\n🏴‍☠️ *Pasangan Zodiak :* ${anu.message.pasangan_zodiak}\n🏴‍☠️ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
           ...
           /**case 'tiktokwm': case 'tiktokwatermark': {
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await naze.sendImage(m.chat, anu.result.thumb, `🏴‍☠️ Title : ${anu.result.title}\n🏴‍☠️ Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                ...
                naze.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `🏴‍☠️ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        naze.sendMessage(m.chat, { image: { url }, caption: `🏴‍☠️ Title : ${anu.title}\n🏴‍☠️ Author : ${anu.author.name}\n🏴‍☠️ Like : ${anu.like}\n🏴‍☠️ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
🏴‍☠️ Inchi: ${inchi}
🏴‍☠️ Pixel: ${pixel}
🏴‍☠️ Video Pixel: ${videoPixel}
🏴‍☠️ Ram: ${ram}
🏴‍☠️ Chipset: ${chipset}
🏴‍☠️ Battery: ${batrai}
🏴‍☠️ Battery Brand: ${merek_batre}
🏴‍☠️ Detail: ${detail}`
            ...
            capt += `🏴‍☠️ Title: ${i.title}\n`
            capt += `🏴‍☠️ Url: ${i.url}\n`
            capt += `🏴‍☠️ Img Url: ${i.img}\n\n──────────────────────\n`
            }
            ...
            for (let i of res.result){
            capt += `🏴‍☠️ Community: ${i.community}\n`
            capt += `🏴‍☠️ Community Link: ${i.community_link}\n`
            capt += `🏴‍☠️ Thumbnail: ${i.community_thumb}\n`
            capt += `🏴‍☠️ Description: ${i.community_desc}\n`
            capt += `🏴‍☠️ Member Count: ${i.member_count}\n\n──────────────────────\n`
            }
            ...
            capt += `🏴‍☠️ Judul: ${judul}\n`
            capt += `🏴‍☠️ Dibaca: ${dibaca}\n`
            capt += `🏴‍☠️ Divote: ${divote}\n`
            capt += `🏴‍☠️ Bab: ${bab}\n`
            capt += `🏴‍☠️ Waktu: ${waktu}\n`
            capt += `🏴‍☠️ Url: ${url}\n`
            capt += `🏴‍☠️ Deskripsi: ${description}`
            naze.sendImage(m.chat, thumb, capt, m)
            }
            break
            ...
            for (let i of res.result) {
            capt += `🏴‍☠️ Judul: ${i.judul}\n`
            capt += `🏴‍☠️ Years: ${i.years}\n`
            capt += `🏴‍☠️ Genre: ${i.genre}\n`
            capt += `🏴‍☠️ Url: ${i.url}\n`
            capt += `🏴‍☠️ Thumbnail Url: ${i.thumbnail}\n\n──────────────────────\n`
            }
...
_Report / Feedback .Report`
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'Info Owner' }, type: 1 },{ buttonId: 'report', buttonText: { displayText: '❗Rules' }, type: 1 }]
